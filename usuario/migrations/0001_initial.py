    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagenperfil', models.ImageField(blank=True, upload_to='fotos_perfil')),
                ('biografia', models.TextField(default='', max_length=100)),
                ('sitioweb', models.URLField(default='')),
                ('educacion', models.CharField(default='', max_length=100)),
                ('trabajo', models.CharField(default='', max_length=100)),
                ('contacto', models.PositiveIntegerField(default=False)),
